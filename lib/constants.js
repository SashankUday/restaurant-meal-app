export const CHEFS_SPECIAL_BADGE = "Chef's special";
...
export const EMPTY_FILTERS = { diets: [], allergens: [], course: null, mealTime: "any", constraints: {}, blockedIngredients: [], showBlocked: false };

export function countActiveConstraints(constraints) {
  if (!constraints) return 0;
  return ["minPrice", "maxPrice", "maxCalories", "minProtein"].filter(
    (key) => constraints[key] !== undefined && constraints[key] !== null && constraints[key] !== "",
  ).length;
}
